...
public class ImageCropActivity extends DocumentScanActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ScannerConstants.selectedImageBitmap != null)
            ...
            Toast.makeText(this, getResources().getString(R.string.image_error), Toast.LENGTH_LONG).show();
            finish();
        }
    }
    ...
    protected void showError(CropperErrorType errorType) {
        switch (errorType) {
            case CROP_ERROR:
                Toast.makeText(this, getResources().getString(R.string.crop_error), Toast.LENGTH_LONG).show();
                break;
        }
    }
    ...
    private void initView() {
        ...
        btnImageCrop.setText(getResources().getString(R.string.done));
        btnClose.setText(getResources().getString(R.string.cancel));
